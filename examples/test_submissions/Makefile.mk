...
test_count_correct.diff:	\
    ${COUNT_CORRECT_FILES:%=$S/common_replies/%.diff}
...
test_javaio_correct.diff:	\
    ${JAVAIO_CORRECT_FILES:%=$S/common_replies/%.diff}
...
test_formatted.diff:	\
    ${FORMATTED_FILES:%=$S/common_replies/%.diff}
...
test_unformatted.diff:	\
    ${UNFORMATTED_FILES:%=$S/common_replies/%.diff}
...
test_forbidden.diff:	\
    ${FORBIDDEN_FILES:%=$S/common_replies/%.diff}
...
test_problem_name.diff:	\
    ${PROBLEM_NAME_FILES:%=$S/common_replies/%.diff}
