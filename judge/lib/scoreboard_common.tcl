...
# Date:		Sun Oct 21 02:49:13 EDT 2001
#
...
scoreboard \[parameters_file\]
	...
	its problem satisifies the logical expression in
	`scoreboard_problems', or that expression is an
	empty list;

	its submitter satisifies the logical expression in
	`scoreboard_submitters', or that expression is an
	empty list;
