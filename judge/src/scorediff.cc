...
"    in the designated group and case of the output\n"
"    and test files.\n"
"\n"
...
"    cases are disjoint sets of lines within a test\n"
"    group, and are numbered 1, 2, 3, ..., with lines\n"
"    before the first test case in a group being\n"
"    treated as being in test case 0.  If the\n"
"    -filtered option is not given, the test group\n"
"    and test case numbers for all lines are 0.\n"
"\n"
...
"    word-boc       type TYPE1 in the first file was\n"
"    word-bog       matched to a token of type TYPE2\n"
"    word-eof       in the second file.\n"
"    number-word\n"
"    number-boc\n"
"    number-bog\n"
"    number-eof\n"
...
"\n"
"		The `-integer A R' option causes all\n"
"		`integer a r' differences with a <= A\n"
"		and r <= R to be ignored, as if they\n"
"		did not exist.  See below for more\n"
"		details.\n"
"\n"
...
"		cal except for letter case (of the\n"
"		exponent `e' or `E') and one or both\n"
"               or their difference is too large to\n"
...
"    difference.  Thus if a word is matched to an\n"
...
"    erence will always be reported as a `float 0 0'\n"
...
"    by a difference type name followed by an un\n"
"    signed integer N sets the limit to N for the\n"
"    named difference.  Thus `-column 5' suppresses\n"
"    all `column' proofs after 5 line-proofs contain-\n"
"    ing `column' proofs have been output.  If N is\n"
"    omitted, it is assumed to be 0 (and next program\n"
